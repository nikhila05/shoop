...
** DONE: How to deal with Service lines with different taxes?
   ...
   - SHOOP-2363
   - It seems that this already refactored correctly by Tuomas

** POSTPONED: Test shipping times?
   - SHOOP-2362

** ACTIONS NOT NEEDED What should we do with the InternalIdentifier?
   - ServiceProvider
   - Service
